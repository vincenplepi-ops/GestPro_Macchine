...
ricompilare l'APK. La versione 1.0.7 forza il caricamento della versione online
...
3. Creare su GitHub una release con tag `android-v1.0.7`.
4. Caricare l'APK con il nome esatto `GestPro-Macchine-Mobile-Android.apk`.
5. Il collegamento di download sarà:
   `https://github.com/vincenplepi-ops/GestPro_Macchine/releases/download/android-v1.0.7/GestPro-Macchine-Mobile-Android.apk`
